...
<html lang="en">
<head>
    <title><?php echo $row7['V_Name'] ?></title>
...
<div>
    <div >
        ...
        <div style="background-color:#white; color:#00303f; ">
            <div align="center">
                <br>
                <h1 style="color: black"><?php echo $row7['V_Name'] ?></h1>
            </div>
            <br>
            <div align="center">
                <div >
                    <div ><img src="./index/White_side%20view.jpg" width="300px;" height="250px;"> </div><br><br>
                    <div  align="center"><h3>
                            VEHICLE NUMBER : <?php echo $row7['Vehicle_No'] ?></br></br>
                            MODEL : <?php echo $row7['Model'] ?></br></br>
                            COLOUR : <?php echo $row7['Color'] ?></br></br>
                            MILAGE : <?php echo $row7['Milage'] ?></br></br>
                            PRICE(Rs) : <?php echo $row7['Price'] ?></br></br>
                        </h3>
                    </div>
                </div>
            </div>
            <br>
            <div align="center">
                <button onclick="window.location.href='Payment.php'"><font color="blue" size="4px"><b>PURCHASE</b></font></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button onclick="window.location.href='HomePage1.php'"><font color="red" size="4px"><b>CLOSE</b></font></button>
            </div>
            <br>
        </div>
