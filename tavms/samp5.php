...
<html lang="en">
<head>
    <title><?php echo $row5['V_Name'] ?></title>
...
<div>
    <div >
        ...
        <div style="background-color:#white; color:#00303f; ">
            <div align="center">
                <br>
                <h1 style="color: black"><?php echo $row5['V_Name'] ?></h1>
            </div>
            <br>
            <div align="center">
                <div >
                    <div ><img src="./index/bmwwhite.jpg" width="300px;" height="250px;"> </div><br><br>
                    <div  align="center"><h3>
                            VEHICLE NUMBER : <?php echo $row5['Vehicle_No'] ?></br></br>
                            MODEL : <?php echo $row5['Model'] ?></br></br>
                            COLOUR : <?php echo $row5['Color'] ?></br></br>
                            MILAGE : <?php echo $row5['Milage'] ?></br></br>
                            PRICE(Rs) : <?php echo $row5['Price'] ?></br></br>
                        </h3>
                    </div>
                </div>
            </div>
